...
// BFF catch-all proxy for /api/wallets/*: the browser only ever calls this same-origin route;
// we forward server-to-server to the Workers API.
// All wallet routes require authentication — no unauthenticated-path branching needed.
