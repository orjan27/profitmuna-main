...
**Current focus:** Phase 06 — settings-notifications
...
| 260607-jcn | Fixed income/expense lists not showing new records until page refresh — overview components now re-sync state via `useEffect` on fresh `initialData`; income edit dialog calls `router.refresh()` after update/delete                                        | 2026-06-07 | d8e639b | [260607-jcn-fix-newly-added-income-and-expense-recor](./quick/260607-jcn-fix-newly-added-income-and-expense-recor/) |
